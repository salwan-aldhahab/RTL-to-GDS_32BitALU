...
# Generated on: Fri Dec 12 02:51:35 EST 2025 (Fri Dec 12 07:51:35 UTC 2025)
...
set logfile fv/alu_1bit/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/alu_1bit -revised fv_map
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -verilog2k ../RTL/src/alu_1bit.v ../RTL/src/arithmetic_circuit.v ../RTL/src/full_adder.v ../RTL/src/logic_circuit.v ../RTL/src/mux4x1.v
elaborate_design -golden -root {alu_1bit} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/alu_1bit/fv_map.v.gz
elaborate_design -revised -root {alu_1bit}
...
write_compared_points noneq.compared_points.alu_1bit.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.alu_1bit.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.alu_1bit.rtl.fv_map.rpt
