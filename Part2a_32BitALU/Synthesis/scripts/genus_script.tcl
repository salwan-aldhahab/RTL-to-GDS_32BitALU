...
set rtlFiles [list ../RTL/src/alu_32bit.v ../RTL/src/alu_1bit.v ../RTL/src/arithmetic_circuit.v ../RTL/src/full_adder.v ../RTL/src/logic_circuit.v ../RTL/src/mux4x1.v]  ;# List of your Verilog source files
set topModule alu_32bit                        ;# Name of your top-level module (here counter.v)
