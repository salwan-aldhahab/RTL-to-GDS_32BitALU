...
# Generated on: Sat Dec 13 13:51:47 EST 2025 (Sat Dec 13 18:51:47 UTC 2025)
...
set logfile fv/alu_32bit/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/alu_32bit -revised fv_map
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -verilog2k ../RTL/src/alu_32bit.v ../RTL/src/alu_1bit.v ../RTL/src/arithmetic_circuit.v ../RTL/src/full_adder.v ../RTL/src/logic_circuit.v ../RTL/src/mux4x1.v
elaborate_design -golden -root {alu_32bit} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/alu_32bit/fv_map.v.gz
elaborate_design -revised -root {alu_32bit}
...
write_compared_points noneq.compared_points.alu_32bit.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.alu_32bit.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.alu_32bit.rtl.fv_map.rpt
