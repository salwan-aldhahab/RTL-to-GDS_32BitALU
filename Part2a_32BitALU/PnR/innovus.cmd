...
#  Created on Sat Dec 13 21:55:56 2025                
#                                                     
#######################################################
...
set init_verilog ../Synthesis/netlist/genus_alu_32bit.v
set init_top_cell alu_32bit
...
getIoFlowFlag
setIoFlowFlag 0
floorPlan -site CoreSite -r 0.925038639876 0.699934 5 5 5 5
uiSetTool select
getIoFlowFlag
fit
...
set_verify_drc_mode -disable_rules {} -check_ndr_spacing auto -check_only default -check_same_via_cell true -exclude_pg_net true -ignore_trial_route false -ignore_cell_blockage false -use_min_spacing_on_block_obs auto -report alu_32bit.drc.rpt -limit 1000
verify_drc
set_verify_drc_mode -area {0 0 0 0}
verifyConnectivity -type all -error 1000 -warning 50
streamOut gds/alu_32bit.gds -mapFile scripts/gpdk045.map -libName DesignLib -merge { scripts/gsclib045.gds } -units 2000 -mode ALL
saveDesign alu_32bit
