...
set rtlFiles [list ../RTL/src/alu_32bit_behavioral.v]  ;# List of your Verilog source files
set topModule alu_32bit_behavioral                        ;# Name of your top-level module (here counter.v)
