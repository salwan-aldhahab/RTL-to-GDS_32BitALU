...
# Generated on: Sat Dec 13 14:18:30 EST 2025 (Sat Dec 13 19:18:30 UTC 2025)
...
set logfile fv/alu_32bit_behavioral/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/alu_32bit_behavioral -revised fv_map
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -verilog2k ../RTL/src/alu_32bit_behavioral.v
elaborate_design -golden -root {alu_32bit_behavioral} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/alu_32bit_behavioral/fv_map.v.gz
elaborate_design -revised -root {alu_32bit_behavioral}
...
set_system_mode lec
write_compared_points noneq.compared_points.alu_32bit_behavioral.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.alu_32bit_behavioral.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.alu_32bit_behavioral.rtl.fv_map.rpt
